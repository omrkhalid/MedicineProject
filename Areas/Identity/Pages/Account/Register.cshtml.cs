...
namespace MedicineProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(!await _roleManager.RoleExistsAsync(SD.ClinicRole))
                {
                    await _roleManager.CreateAsync(new IdentityRole(SD.ClinicRole));
                ...
                if (result.Succeeded)
                {
                    ...
                    if(role == SD.ClinicRole)
                    {
                        await _userManager.AddToRoleAsync(user, SD.ClinicRole);
                    }
                    else
                    {
